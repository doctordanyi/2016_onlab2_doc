...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Danyi Dávid}
\newcommand{\vikkonzulens}{Kovács Viktor}
\newcommand{\vikcim}{3D rekonstrukció Kinect alkalmazásával}
\newcommand{\viktanszek}{Automatizálási és Alkalmazott Informatika Tanszék}
\newcommand{\vikdoktipus}{Beszámoló}
\newcommand{\vikdepartmentr}{Danyi Dávid}
